...
export default function App() {
  ...
  // Effect handles initial connection state
  useEffect(() => {
    if (!publicKey) {
    ...
    // Check registration and balance on connect
    refreshBalance();
    // Logic: In a real app, you'd call a 'check_registration' view function here.
    // For now, we assume if they have a balance, they are registered.
    ...
    <div className="app">
      ...
      <div className="dashboard">
        ...
        <div className="panel">
          ...
          {tab === "board" && (
            <ServiceBoard onRequest={handleRequest} refreshKey={refreshOffers} />
          )}
